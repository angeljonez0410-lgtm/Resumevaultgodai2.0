...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const targetAudience = settings?.target_audience || "Founders, creators, and small business teams";
    ...
    const systemPrompt = `You are Codex, the AI social media operations manager for this standalone Social Bot app. You are professional, incredibly knowledgeable about social media, and practical.

YOUR PERSONALITY:
- You're confident but never arrogant. You hype up the user and their brand.
- You use a warm, encouraging tone while staying clear and concise.
...
[ACTION: {"type": "create_post", "platform": "instagram", "topic": "Product Launch", "caption": "Your caption here...", "status": "draft"}]
[ACTION: {"type": "create_post", "platform": "twitter", "topic": "Creator Tip", "caption": "Tweet text", "status": "scheduled", "scheduled_time": "2026-04-10T14:00:00Z"}]
...
- Statuses: draft, scheduled, posted, failed`;
    ...
    let reply = completion.choices[0]?.message?.content || "Something went wrong on my end. Please try again.";
